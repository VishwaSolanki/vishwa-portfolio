       ...
       className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch ">
            ...
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <p className="text-zinc-400 mt-3 mb-8 max-[50ch] lg:max-w-[30ch] reveal-up">
                Eager to contribute and grow through meaningful opportunities in a dynamic environment.
                </p>
        ...
        <form
        action="https://getform.io/f/allyvxea"
        method="POST"
